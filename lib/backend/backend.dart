...
import 'schema/book_service_record.dart';
...
import 'schema/prov_services_record.dart';
...
export 'schema/book_service_record.dart';
...
export 'schema/prov_services_record.dart';
...
/// Functions to query BookServiceRecords (as a Stream and as a Future).
Future<int> queryBookServiceRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      BookServiceRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<BookServiceRecord>> queryBookServiceRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      BookServiceRecord.collection,
      BookServiceRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<BookServiceRecord>> queryBookServiceRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
...
/// Functions to query ProvServicesRecords (as a Stream and as a Future).
Future<int> queryProvServicesRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      ProvServicesRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<ProvServicesRecord>> queryProvServicesRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      ProvServicesRecord.collection,
      ProvServicesRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<ProvServicesRecord>> queryProvServicesRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
