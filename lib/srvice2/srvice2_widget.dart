...
import 'srvice2_model.dart';
export 'srvice2_model.dart';

class Srvice2Widget extends StatefulWidget {
  const Srvice2Widget({
    super.key,
...
class _Srvice2WidgetState extends State<Srvice2Widget> {
  late Srvice2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Srvice2Model());
  }
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              gradient: LinearGradient(
                colors: [const Color(0xFFE3F0F8), FlutterFlowTheme.of(context).info],
                stops: const [0.0, 1.0],
                          ...
                          child: Padding(
                            ...
                            child: StreamBuilder<List<ServicesRecord>>(
                              ...
                              builder: (context, snapshot) {
                                ...
                                List<ServicesRecord>
                                    listViewServicesRecordList = snapshot.data!;
